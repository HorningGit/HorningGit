...
<table>
 ...
 - Implementing ACLs and routing protocols in Cisco IOS.

 - Writing and maintaining documentation for technical information and audit reports.

 - Background in running, terminating, and splicing both fiber and a variety of Ethernet cables.

 - Assisting the implementation of Hyper-V to support Windows Server systems alongside Marine Corps Data Systems Administrators (0671).</td>
...
- Configured firewall settings for SSL VPN users, open/closed ports, and remote access.

- Imaged workstations, assigned Windows licenses, and adding/removing workstations from MSP toolkits.

- Detailed implementation of ticketing software and assisted with purchase requests for workstations and servers.

- Coordinated with software vendors for customers (QuickBooks, Dentrix, DockMaster, etc.)</td>
...
IaC & Source Control | <img alt="Ansible" src="https://img.shields.io/badge/Ansible-000000?style=plastic?&logo=ansible&logoColor=white" /> <img alt="Git" src="https://img.shields.io/badge/Git-E44C30?style=plastic?&logo=git&logoColor=white" />
